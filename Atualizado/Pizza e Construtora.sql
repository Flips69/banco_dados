...
-- Exercicio 3 b
delimiter //
	create function calcular_custo_projeto(id int) returns decimal(15,2)
	begin
...
-- Exercicio 2 a
delimiter //
create procedure inserir_funcionario(x_nome varchar(255), x_email varchar(255), x_departamento int, x_valor_hora decimal(15,2))
begin
