...
/*
 * create trigger <nome> <quando> <ação> on <table> for each row
 * begin
 * <comando 1>
 * <comando 2>
 * end;
 ...
 * quando-> se o gatilho é ativado antes ou dps
 * ação-> oq o gatilho vai fazer(insert, update ou delete)
 */
...
begin
	insert into log (data_hora, tabela, atividade, id, aux)
		values (current_timestamp(), 'Cliente', 'Insert', new.cliente_id, concat('Nome', new.nome, 'Telefone: ', new.telefone, ', Logradouro: ', new.logradouro, ', Bairro: ', new.bairro));
end//
...
begin
	insert into log (data_hora, tabela, atividade, id, aux)
		values (current_timestamp(), 'Cliente', 'Update', old.cliente_id, concat('Nome', old.nome, 'Telefone: ', old.telefone, ', Logradouro: ', old.logradouro, ', Bairro: ', old.bairro));
	insert into log (data_hora, tabela, atividade, id, aux)
		values (current_timestamp(), 'Cliente', 'Update', new.cliente_id, concat('Nome', new.nome, 'Telefone: ', new.telefone, ', Logradouro: ', new.logradouro, ', Bairro: ', new.bairro));
end//
...
begin
	insert into log (data_hora, tabela, atividade, id, aux)
		values (current_timestamp(), 'Cliente', 'Delete', old.cliente_id, concat('Nome', old.nome, 'Telefone: ', old.telefone, ', Logradouro: ', old.logradouro, ', Bairro: ', old.bairro));
end//
